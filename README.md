...
- ⚙️ Анализ механик и архитектуры  
...
### 3. 🗄️ SQL – создание таблиц, SELECT, WHERE, подзапросы
...
### 4. 🐞 Тестирование уровня (18 баг-репортов)
...
### 5. ⚡ Тестирование производительности (World of Tanks)
[📁 Перейти к папке](https://github.com/Bilych31/Game-Dev-Qa-Engineer-portfolio/tree/main/Портфолио%20Game%20Dev%20QA%20Engineer/Тестирование%20производительности)

Отчёт о тестировании производительности, проведённом с помощью MSI Afterburner.  
- Анализ стабильности FPS, 1% low и 0.1% low.  
- Оценка просадок в сценах с массовыми эффектами (залп «Катюши»).  
- Заключение: система обеспечивает комфортный геймплей при максимальных настройках, единичные короткие просадки не влияют на восприятие.

---

### 6. 🤖 Unity PlayMode автотест
...
### 7. ⏱️ Планирование и оценка трудозатрат
...
### 8. 🕹️ Консольное тестирование (Black Mesa)
...
### 9. 🧑‍💻 Работа с поддержкой (приоритезация багов)
[📁 Перейти к папке](https://github.com/Bilych31/Game-Dev-Qa-Engineer-portfolio/tree/main/Портфолио%20Game%20Dev%20QA%20Engineer/Работа%20с%20поддержкой%20(приоритезация%20багов))

Анализ обращений игроков в техподдержку, приоритизация по критичности.  
- Разбор 20 обращений с классификацией (Critical / High / Normal / Low / Reject).  
- Определены критерии: платежи, вайп прогресса, массовость, сегмент игрока.  
- Составлен план действий для каждого типа обращения (передача в QA, возврат средств, шаблонный ответ).

---

### 10. 📱 Мобильная монетизация (Flippy Knife)
...
### 12. 🌐 Браузерные игры vs соцсети (Super City)
...
### 13. 🧪 Тест-дизайн (эквивалентность, границы, таблица решений)
...
### 14. 📊 Снятие логов через ADB (эмулятор Android)
[📁 Перейти к папке](https://github.com/Bilych31/Game-Dev-Qa-Engineer-portfolio/tree/main/Портфолио%20Game%20Dev%20QA%20Engineer/Снятие%20логов%20через%20ADB%20(эмулятор%20Android))

Примеры использования ADB logcat для отладки мобильных приложений.

---

### 15. 🧩 Классификация видов тестирования
[📁 Перейти к папке](https://github.com/Bilych31/Game-Dev-Qa-Engineer-portfolio/tree/main/Портфолио%20Game%20Dev%20QA%20Engineer/Классификация%20видов%20тестирования)
